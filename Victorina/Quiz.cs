...
namespace Victorina
{
    internal class Quiz
    {
        ...
        List<string> questions = new List<string>()
        {
            ...
            "Что из перечисленного является двоичным кодом?"
        };

        List<string[]> variantsQuestions = new List<string[]>()
        {
            new string[4] { "Усложнение простой задачи", "Не признаю ООП", "Не знаю", "Объектно-ориентированное программирование" },
            new string[4] { "8", "9", "12", "2" },
            new string[4] { "C++", "Алгоритмический язык программирования", "Python", "HTTP" },
            new string[4] { "01", "12", "00", "735" }
        };
